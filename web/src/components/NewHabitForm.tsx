    ...
    return (
        <form onSubmit={createNewHabit} action="" className="w-full flex flex-col mt-6">
            ...
            <input 
                ...
                className="p-4 round-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-400 focus: outline-none focus:ring-2 focus:ring-zinc-900 focus:ring-offset-2 focus:ring-offset-background"
                autoFocus
                value={title}
            ...
            <button
                type="submit"
                className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 bg-green-600 hover:bg-green-500 font-semibold transition-colors focus: outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zinc-900"
            >
